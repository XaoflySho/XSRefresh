...
Pod::Spec.new do |spec|
  ...
  An easy way to use pull-to-refresh, MJRefresh with swift version.
                   DESC
  ...
  # Or just: spec.author    = "Xaofly Sho"
  # spec.authors            = { "Xaofly Sho" => "shaoxiaof@hotmail.com" }
  # spec.social_media_url   = "https://twitter.com/Xaofly Sho"
  ...
  spec.source_files  = "XSRefresh/**/*"
  # spec.exclude_files = "XSRefresh/Exclude"
